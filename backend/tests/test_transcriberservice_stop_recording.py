...
class TestTranscriberServiceStopRecording:
    ...
    def service_recording(self):
        ...
        service._recorder._stream = Mock()
        service._recorder._recording_start_time = 0
        service._recorder._native_samplerate = 16000
        service._recorder._buffer = [np.array([0.1, 0.2, 0.3], dtype=np.float32)]
        return service
    ...
    def test_stop_recording_stops_stream(self, service_recording):
        ...
        stream = service._recorder._stream
